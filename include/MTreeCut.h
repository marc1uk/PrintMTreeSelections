...
// XXX disable so we don't depend on Boost
/*#include<SerialisableObject.h>  // so we can put these in a BoostStore*/

class MTreeCut /*: public SerialisableObject*/ {
	
/*	friend class boost::serialization::access;  XXX disable so we don't depend on Boost */
...
//			ar & additional_indices;
	...
	*/
	bool serialise; // we need to declare this manually instead though
